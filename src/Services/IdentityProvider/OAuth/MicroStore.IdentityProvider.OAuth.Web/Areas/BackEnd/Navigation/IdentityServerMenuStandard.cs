namespace MicroStore.IdentityProvider.OAuth.Web.Areas.BackEnd.Navigation
{
    public static class IdentityServerMenuStandard
    {

        public static class ApiResourceMenu
        {
        ...
        public static class ApiScopeMenu
        {
