...
using MicroStore.IdentityProvider.OAuth.Application.ApiScopes;
using MicroStore.IdentityProvider.OAuth.Application.Clients;
...
using MicroStore.IdentityProvider.OAuth.Web.Areas.BackEnd.Models.Clients;

namespace MicroStore.IdentityProvider.OAuth.Web.Areas.BackEnd.Controller
{
    [Authorize]
