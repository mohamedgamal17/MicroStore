...
namespace MicroStore.BuildingBlocks.AspNetCore.ExceptionHandling
{
    internal class MicroStoreExceptionHandlingMiddleware : IMiddleware, ITransientDependency
    {
        private readonly ILogger<MicroStoreExceptionHandlingMiddleware> _logger;

        private readonly Func<object, Task> _clearCacheHeadersDelegate;

        public MicroStoreExceptionHandlingMiddleware(ILogger<MicroStoreExceptionHandlingMiddleware> logger)
        {
            _logger = logger;
