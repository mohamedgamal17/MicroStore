...
namespace MicroStore.Client.PublicWeb.Pages.Payment
{
    public class CompleteModel : PageModel
    {
        ...
        public CompleteModel(ICookieManager cookieManager, UserPaymentRequestService userPaymentRequestService, BasketService basketService, IWorkContext workContext)
        {
