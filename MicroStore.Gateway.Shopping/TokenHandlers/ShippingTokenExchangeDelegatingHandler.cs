...
{
    public class ShippingTokenExchangeDelegatingHandler : BaseTokenExchangeDelegatingHandler
    {
        const string CacheKey = "mvcgatewaytodownstreamtokenexchangeclient_shipping";
        public ShippingTokenExchangeDelegatingHandler(IHttpClientFactory httpClinetFactory, IClientAccessTokenCache clientAccessTokenCache, IHttpContextAccessor httpContextAccessor, IOptions<IdentityProviderOptions> identityProviderOptions, IOptions<GatewayClientOptions> gatewayClientOptions) : base(httpClinetFactory, clientAccessTokenCache, httpContextAccessor, identityProviderOptions, gatewayClientOptions)
        {
        }

        protected override List<string> RequiredScopes => ShippingScope.List();
