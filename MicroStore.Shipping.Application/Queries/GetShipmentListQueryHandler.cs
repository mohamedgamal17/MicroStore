...
{
    public class GetShipmentListQueryHandler : QueryHandler<GetShipmentListQuery>
    {
        ...
        public override async Task<ResponseResult> Handle(GetShipmentListQuery request, CancellationToken cancellationToken)
        {
