...
namespace MicroStore.IdentityProvider.Host.Areas.BackEnd.Controller
{
    public class ApiResourceController : BackEndController
    {
        ...
        {
            var pagingOptions  = new PagingQueryParams { Lenght = model.PageSize  , Skip = model.Skip};
        ...
        [HttpPost]
        public async Task<IActionResult> DeleteProperty(RemovePropertyUIModel model)
        {
