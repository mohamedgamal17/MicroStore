...
namespace MicroStore.ShoppingGateway.ClinetSdk.Services.Cart
{
    public class BasketService
    {
        ...
        public async Task<HttpResponseResult<Basket>> AddItemAsync(string userId, BaskeItemRequestOptions options , CancellationToken cancellationToken= default)
        {
        ...
        public async Task<HttpResponseResult<Basket>> UpdateAsync(string userId , BasketRequestOptions options , CancellationToken cancellationToken = default)
        {
        ...
        public async Task<HttpResponseResult<Basket>> RemoveItemsAsync(string userId , BasketRemoveItemRequestOptions options, CancellationToken cancellationToken = default)
        {
